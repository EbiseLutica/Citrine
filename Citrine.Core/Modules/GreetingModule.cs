...
namespace Citrine.Core.Modules
{
	...
	public class GreetingModule : ModuleBase
	{
		...
		public GreetingModule()
		{
			...
			Add(new MultiplePattern(@"(遊|あそ)(ぼ|びま(しょ|せんか))", new[] {
				"いいよ〜! なにする?",
				"ごめん, 今はちょっと忙しくて...",
			}, null, new []{ "いやだ." }));
			...
			Add(new MultiplePattern("さわさわ|もみもみ|すりすり|ぎゅ|もちもち", new[] {
				"う, くすぐったいよ!",
				"せ, セクハラですか!? ぐぬぬ",
				"はぁ, 触られたら触られる覚悟はできてるんでしょうね!",
				"や、くすぐったいって!",
				"うーーー!",
				"はわわわ..."
			}, new[] {
			...
			Add(new MultiplePattern(@"(ませんか|ないか|[らし]ね[えぇエェ]か)[？\?]?$", new[] {
				"考えておきます",
				"賛成!",
				"んー, あんま乗り気じゃないです",
				"なんで?",
				"いいね〜",
				"ちょうど僕もそう思ってた頃だよ, $user$",
			}, null, new[] {
				"...", "?",  ""
			}));

			Add(new MultiplePattern(@"よ$", new[] {
				"なるほど",
				"ふむ",
				"なるほど, 少しわかったかも",
				"んー...?",
